...
const Layout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-white text-gray-900">
      {/* Header */}
      <header className="bg-white bg-opacity-90 backdrop-blur-sm shadow-lg p-4 sticky top-0 z-10 border-b border-gray-200">
        <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between">
          <h1 className="text-3xl font-bold text-emerald-700 mb-2 sm:mb-0">EduCycle</h1>
          {currentUser && (
      ...
      {currentUser && (
        <nav className="fixed bottom-0 left-0 right-0 bg-white bg-opacity-90 backdrop-blur-sm shadow-lg p-3 z-20 md:sticky md:bottom-auto md:top-auto md:relative md:p-4 border-t border-gray-200">
